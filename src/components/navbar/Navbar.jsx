        ...
        <li className={styles.dropdown}>
          ...
          {isDropdownOpen && (
            <ul className={styles.dropdownContent}>
              <li><Link href="/computer_application" className={pathname === "/" ? styles.active : "/computer_application"}>
                  Computer Application
              </Link></li>
              <li><Link href="/computer_maintainance" className={pathname === "/computer_maintainance" ? styles.active : ""}>
                  Computer Maintainance
              </Link></li>
              <li><Link href="/computer_networking" className={pathname === "/computer_networking" ? styles.active : ""}>
                  Computer Networking
              </Link></li>
              <li><Link href="/remote_sensing" className={pathname === "/remote_sensing" ? styles.active : ""}>
                  Remote Sensing and GIS
              </Link></li>
              <li><Link href="/software-engineering" className={pathname === "/software-engineering" ? styles.active : ""}>
